...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('tempale/plugins/fontawesome-free/css/all.min.css')}}">
  <!-- Theme style -->
...
<!-- jQuery -->
<script src="{{asset('tempale/plugins/jquery/jquery.min.js')}}"></script>
<!-- Bootstrap 4 -->
<script src="{{asset('tempale/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- AdminLTE App -->
